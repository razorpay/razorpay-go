...
func TestSettlementOndemandNewWithOptionalParams(t *testing.T) {
	...
	_, err := client.Settlements.Ondemand.New(context.TODO(), razorpay.SettlementOndemandNewParams{
		Amount:      200000,
		Description: razorpay.String("Need this to make vendor payments."),
		...
		SettleFullBalance: razorpay.Bool(false),
	})
	if err != nil {
