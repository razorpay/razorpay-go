...
import (
	...
	"github.com/razorpay/razorpay-go/v2/internal"
...
func TestUserAgentHeader(t *testing.T) {
	...
	client.Orders.List(context.Background(), razorpay.OrderListParams{})
...
func TestRetryAfter(t *testing.T) {
	...
	_, err := client.Orders.List(context.Background(), razorpay.OrderListParams{})
	if err == nil {
...
func TestContextCancel(t *testing.T) {
	...
	cancel()
	_, err := client.Orders.List(cancelCtx, razorpay.OrderListParams{})
	if err == nil {
		t.Error("Expected there to be a cancel error")
	}
}
...
func TestContextDeadline(t *testing.T) {
	...
	go func() {
		...
		_, err := client.Orders.List(deadlineCtx, razorpay.OrderListParams{})
		if err == nil {
